...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # The following is an alternative method to above to avoid hard-coded values:
                                # site_list = spacex_df['Launch Site']
                                # site_list = site_list.drop_duplicates(keep='first', inplace=False)
                                # dcc.Dropdown(id='site-dropdown', options =[{'label': i, 'value': i} for i in site_list],
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values = 'class count', names = 'class', title='Total Success Launces for site ' + entered_site)
        return fig
